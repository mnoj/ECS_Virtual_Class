...
class RX_key(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RX_key")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(433e6, 435e6, 1, 433.92e6, 200)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-0.3, 0.3)
        ...
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_complex_to_mag_0, 0))
...
def main(top_block_cls=RX_key, options=None):

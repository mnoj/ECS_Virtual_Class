...
class FM_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Fm Rx", catch_exceptions=True)
        ...
        self.channel_freq = channel_freq = 94.7e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(92e6, 108e6, 10e3, 94.7e6, 200)
        ...
        self._audio_gain_range = Range(0, 2, 0.1, 1, 200)
        ...
        self.qtgui_freq_sink_x_0_0_0.set_block_alias("csdfdsfdsf")
